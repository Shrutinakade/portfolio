...
const Footer = () => {
    return (
        <footer
            class="flex flex-col items-center bg-zinc-50 text-center text-surface bg-gradient-to-b from-black to-gray-800">
            <div class="container px-6 pt-6">
                <div class="mb-6 flex justify-center space-x-2 p-5">
                    <a
            ...
            <div class="w-full bg-black/5 p-4 text-center font-serif text-xl text-white">
                Copyright © 2024 | Made with ❤ by Shruti Nakade | All Rights Reserved
